...
- confirm intended actions by default unless the user was already explicit or the local guide clearly allows a stronger default
- if there is no guidance and the handling is ambiguous, ask instead of guessing
- format commit messages as `<parent folder>: <whatever the edit was>`
