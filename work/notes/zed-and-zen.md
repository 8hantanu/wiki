...
My primary workflow happens with tmux + nvim + opencode. Usually when I am pair-programming or sharing my work with others, people find it difficult to navigate, so I prefer opening my project folder in a GUI code editor.
